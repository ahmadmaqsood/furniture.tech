...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg bg-danger py-4 px-5 navbar-copy">
        <div className="container-fluid">
          <Link className="navbar-brand " to="/"><img src={logo} className="position-absolute z-3 top-0 start-0 " alt='pic of logo' width="140" /></Link>
          ...
          <div className="collapse navbar-collapse mt-5 mt-md-0 " id="navbarSupportedContent">
            ...
            <form className={`d-flex ${props.display}`} role="search">
            ...
            <div className="extra-links ">
              <div className={`account ${props.display}`}>
